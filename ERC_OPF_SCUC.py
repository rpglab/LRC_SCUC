...
# Parameters settings
#*********************************************************************************************************
r0 = 4 # solar power coefficient
sen = 0.96 # wind power coefficient
alpha = -0.5
RoCoFE = 0.5 # RoCoF threshold
RoCoF = 0.5 # RoCoF threshold
fn = 60 # base frequency
HS = fn*200*2/RoCoF
virtual_price = 0.01
model = AbstractModel()
#*********************************************************************************************************
